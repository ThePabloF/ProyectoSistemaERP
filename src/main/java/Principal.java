...
public class Principal {
    public static void main(String[] args) {
        ...
        Producto producto1 = new ProductoSinIva(100,"Grapadora",7.50,proveedor1,CategoriaProducto.OFICINA,"Producto de oficina");
        Producto producto2 = new ProductoSinIva(101,"Impresora",170.50,proveedor2,CategoriaProducto.HARDWARE,"Producto de impresion");
        Producto producto3 = new ProductoSinIva(102,"Escoba",4,proveedor3,CategoriaProducto.LIMPIEZA,"Producto de limpieza");
